    ...
    <div
      className={`absolute ${
        side === "left"
          ...
          : "right-0 bottom-24 translate-x-1/4"
      } bg-white rounded-xl shadow-lg border border-gray-border px-4 py-3 flex items-center gap-3 w-44 z-10`}
    >
      ...
      <div className="min-w-0">
        ...
        <div className="flex items-center gap-1 mt-0.5">
          ...
          <span className="text-[9px] text-slate-400">Role Ready</span>
        </div>
      </div>
    </div>
  );
...
export default function Hero() {
  return (
    <section className="relative w-full bg-white overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-[600px] h-[400px] bg-brand-blue/5 rounded-tr-[100px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 pt-20 pb-28">
        <div className="flex flex-col items-center text-center max-w-3xl mx-auto relative">
          {/* Label */}
          <span className="text-brand-blue text-xs font-semibold tracking-widest uppercase mb-6">
            Recruitment Redefined
          </span>

          {/* Heading with floating cards */}
          <div className="relative w-full">
            <FloatingCard name="Sarah M." role="Senior Nurse" side="left" />
            <FloatingCard name="James T." role="Head Chef" side="right" />

            <h1 className="text-5xl lg:text-6xl font-black tracking-tight text-brand leading-[1.08] mb-6">
              Hire Pre-Vetted
              <br />
