...
function FloatingCard({
  ...
  return (
    <div
      data-hero="card"
      className={`hidden md:flex absolute bg-white dark:bg-[#111827] rounded-xl shadow-lg border border-gray-border dark:border-white/10 px-4 py-3 items-center gap-3 w-44 z-10 ${className}`}
    >
      <div className="w-9 h-9 rounded-full bg-gray-soft dark:bg-[#0B1222] border border-gray-border dark:border-white/10 flex items-center justify-center flex-shrink-0">
        <svg
          width="18"
          height="18"
          viewBox="0 0 24 24"
      ...
      <div className="min-w-0">
        ...
        <div className="flex items-center gap-1 mt-0.5">
          ...
          <span className="text-[9px] text-slate-400 dark:text-slate-500">{status}</span>
        </div>
      </div>
    </div>
  );
...
export default function Hero() {
  return (
    <section className="relative w-full bg-white dark:bg-[#111827] overflow-hidden min-h-[92vh] flex items-center">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 py-32 w-full">
        <div className="flex flex-col items-center text-center max-w-3xl mx-auto">
          ...
          {/* Heading */}
          <h1 data-hero="heading" className="text-5xl lg:text-7xl font-black tracking-tight text-brand dark:text-white leading-[1.06] mb-6">
            Hire Pre-Vetted
            <br />
          ...
          {/* Subtitle */}
          <p data-hero="subtitle" className="text-slate-500 dark:text-slate-400 text-lg leading-relaxed max-w-xl mb-10">
          ...
          {/* Trust strip */}
          <div data-hero="trust" className="mt-12 flex items-center gap-6 text-slate-400 dark:text-slate-500 text-xs">
