...
function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 w-[260px] h-screen flex flex-col bg-white dark:bg-[#111827] border-r border-gray-100 dark:border-[#1e293b] z-40">
      {/* Logo */}
      <div className="h-[72px] flex flex-col justify-center px-6 border-b border-gray-100 dark:border-[#1e293b]">
      ...
      {/* Bottom: user + logout */}
      <div className="px-3 pb-5 border-t border-gray-100 dark:border-[#1e293b] pt-4 space-y-2">
        ...
        <button onClick={handleLogout} className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-red-400 bg-red-50 hover:bg-red-100 transition-all">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75">
