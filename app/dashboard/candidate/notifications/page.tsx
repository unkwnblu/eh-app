            ...
            <div key={label}>
              ...
              <div className="space-y-2">
                {items.map((n) => {
                  ...
                  const offerOutcome   = !isOfferReceipt && (n.metadata?.acted as string | boolean | undefined);
                  ...
                  return (
                    <div
                      key={n.id}
                      onClick={() => { if (!n.read && !isPendingOffer) markOneRead(n.id); }}
                      className={`group relative bg-white dark:bg-[#1a2332] rounded-2xl border transition-all duration-200 ${
                        isPendingOffer ? "cursor-default" : "cursor-pointer hover:shadow-sm"
                      } ${
                        n.read
                    ...
                    >
                      <div className="flex items-start gap-4 p-5">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {/* Outcome badge — shown after the candidate has acted on an offer */}
                          {offerOutcome && (
