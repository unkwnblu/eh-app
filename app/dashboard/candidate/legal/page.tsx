  ...
  return (
    <main className="flex-1 px-4 py-6 md:px-8 md:py-8 space-y-6">
      ...
      <div className="flex items-start justify-between gap-4" data-gsap="fade-down">
        ...
        <button className="flex items-center gap-2 border border-gray-200 rounded-xl px-4 py-2.5 text-sm font-semibold text-slate-500 hover:bg-white hover:shadow-sm transition-all shrink-0">
      ...
      {/* ── Stat cards ── */}
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4" data-gsap="fade-up">
        {[
      ...
      <div className="bg-brand-blue rounded-2xl px-6 py-5 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4" data-gsap="fade-up">
        ...
        <button className="w-full sm:w-auto px-6 py-2.5 bg-white text-brand-blue text-sm font-bold rounded-xl hover:bg-white/90 transition-colors shrink-0">
          Submit Final Review
        </button>
      </div>
