...
const FAQS = [
  {
    ...
    answer: "Navigate to Job Management from the sidebar, then click the 'Post New Job' button in the top right. Fill in the job details, compliance requirements, and salary information, then click 'Post Job Now'.",
  },
  {
    id: 2,
    question: "How does shift scheduling work?",
    answer: "Go to Shift Management and select a live job role. From the role's detail page you can create new shifts, assign candidates, and monitor fill rates in real time. Use the 'Quick Fill' button for unassigned shifts.",
  },
  {
    id: 3,
    question: "What compliance checks does EdgeHarbour perform?",
    answer: "EdgeHarbour verifies DBS certificates, mandatory training certifications, and right-to-work documentation for every candidate. You'll receive alerts when any credentials are approaching expiry.",
  },
  {
    id: 4,
    question: "How do I message a candidate?",
    answer: "Open the candidate's profile from the job pipeline or shift roster, then click the message icon. You can also access all conversations from the Messaging section in the sidebar.",
  },
  {
    id: 5,
    question: "Can I export my shift and applicant data?",
    answer: "Yes. On the Upcoming Shifts table within any role's shift management page, click the 'Export' button to download a CSV of shift records including candidate details and compliance status.",
  },
];
...
const CONTACT_CHANNELS = [
  {
    ...
    label: "Email Support",
    value: "support@edgeharbour.co.uk",
        ...
        <main className="flex-1 px-6 py-6 lg:px-8 lg:py-8 space-y-6">
          ...
          <div className="flex flex-col lg:flex-row gap-5">
            ...
            <div className="flex-1 bg-white border border-gray-100 rounded-2xl p-7" data-gsap="fade-up">
              ...
              <p className="text-sm text-slate-400 mb-5 ml-11">Quick answers to common questions.</p>
              <div>
                {FAQS.map((faq) => (
              ...
              <div className="bg-white border border-gray-100 rounded-2xl p-7">
                ...
                {submitted ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <button
                      type="submit"
                      className="w-full py-2.5 bg-brand-blue text-white rounded-xl text-sm font-bold hover:bg-brand-blue-dark transition-colors shadow-sm"
                    >
                      Send Message
                    </button>
                  </form>
